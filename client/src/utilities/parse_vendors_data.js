...
//         .map((i) => {
//           return {
//             visiting_hour: i.visiting_hour,
//             reserved_spots: i.reserved_spots
//           }
//         })
//       const columns = ["visiting_hour", "reserved_spots"]
//       setState(prev => ({ ...prev, ...{ stores, columns } }))
//     })
//     .catch(err => err);
// }

const data = callAPIForVendors()
// const data = [
//   {
//     "vendor_id": 6,
//     "name": "Persia",
